...
{
    QSqlQuery query;
     QString id_cl_string = QString::number(id_cl);  // Convert id_cl to a string

        query.prepare("INSERT INTO clients (id_cl, nom_c, prenom_c, email, telephone, adresse, ty_peau, taille, poids, genre, point_fed, \"AGE\") "
                      "VALUES (:id_cl, :nom_c, :prenom_c, :email, :telephone, :adresse, :ty_peau, :taille, :poids, :genre, :point_fed, :age)");

        // Correct binding for id_cl
        query.bindValue(":id_cl", id_cl_string);
