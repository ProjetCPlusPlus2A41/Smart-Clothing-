...
#include <memory>
#include "../../EMPLOYEE/calendarwidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_CalendarWidget_t, stringdata0) + ofs), len 
...
const QMetaObject CalendarWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CalendarWidget.offsetsAndSize,
