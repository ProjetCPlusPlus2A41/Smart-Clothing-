...
"border-radius: 10px; /* Coins arrondis */"));
        ...
        comboBox_question->addItem(QString());
        comboBox_question->addItem(QString());
        comboBox_question->setObjectName(QString::fromUtf8("comboBox_question"));
...
""));
        ...
        lineEdit_email_forgot->setObjectName(QString::fromUtf8("lineEdit_email_forgot"));
...
"border-radius: 10px; /* Coins arrondis */"));
        ...
        lineEdit_repeat_password->setObjectName(QString::fromUtf8("lineEdit_repeat_password"));
...
"}"));
        ...
        lineEdit_new_password->setObjectName(QString::fromUtf8("lineEdit_new_password"));
